...
- 专注跨境电商数据分析、市场洞察与经营策略。用数据定位问题，用 AI 放大分析效率，让洞察真正落到业务结果。
...
|调研效率提升|协同效率提升|新品推动开发|
|---|---|---|
|**60%**|**30%**|**10\+**|

## ⭕核心能力

|**分析方法**|商业分析、经营分析、市场洞察、业务诊断、ROI 测算、归因分析|
|---|---|
|**数据工具**|SQL、Tableau、BI、Excel、RPA|
|**AI 提效**|Codex、Vibe Coding、Agent、ChatGPT、Gemini|
|**业务场景**|跨境电商、供应链、物流运营、新品研究、增长策略|

## 🏢工作经历

### 深圳合沣网络科技有限公司

**跨境电商商业分析**　2025\.10 — 2026\.07

搭建销售、供应链与物流联动的自动化分析体系，负责经营诊断、新品研究和 AI 提效，推动销量增长与业务流程优化。

### 新企航供应链有限公司

**跨境物流数据运营**　2024\.01 — 2025\.09

构建 Tableau 销售 BI 看板与经营分析框架，支持客户分层、增长策略、物流时效预测和跨部门数据需求。

## 🚀代表作品

### AI 驱动跨境电商新品调研

市场研究｜2025\.10 — 2026\.07

调研 30\+ 产品、分析 6000\+ 用户评论，结合 AI 完成竞品清洗、卖点打标与市场机会识别，支持新品筛选和优先级判断。

**业务结果：**调研效率提升 60%，推动 10\+ 新品开发。

**关键词：**市场容量｜用户洞察｜AI 竞品分析

[查看完整作品 ↗](https://my.feishu.cn/wiki/X9UywMm7EiPzd8kXoX5cDmH9nFh?from=from_copylink)

### 跨境多维表联动与 BI 看板

数据产品｜2024\.01 — 2025\.09

整合销售、供应链与物流数据，搭建可下钻的 Tableau 经营看板与自动预警体系，让业务团队实时掌握货量、利润和履约表现。

**业务结果：**业务人效提升 30%，毛利率提升 3%。

**关键词：**Tableau｜数据建模｜自动预警

[查看跨境多维表作品 ↗](https://my.feishu.cn/wiki/GIRQwGiIginaGCkAK3lcZA3FnZb?from=from_copylink)　[查看 BI 看板 ↗](https://public.tableau.com/views/-UK_17769154366490/-1?:language=zh-CN&publish=yes&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link)

### 跨境经营分析与策略输出

经营分析｜2025\.03 — 2026\.07

围绕收入、利润、广告和库存建立经营诊断框架，定位风险与增长机会，并将分析结论转化为可执行的促销、协同和流程策略。

**业务结果：**分析 6000+ 用户评论，销量增长 5%。

**关键词：**经营诊断｜增长策略｜ROI 测算｜评论分析

[查看经营分析报告 ↗](https://my.feishu.cn/wiki/QZ9vw3eb8iAvbmk7t4AcxI6znge?from=from_copylink)   [查看 评论分析HTML 看板 ↗](https://analysis.esthercui.cn/)
